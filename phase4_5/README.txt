...
How to compile and run our tests in folder "/testMains":
    ...
    make test_stack; -> For compiling and running the stackTestMain.c test file.

-The quads are printed to the file "quads_output.txt".
-Short-circuit evaluation is implemented.

-Phase_3 was tested on 'portokali'.
